...
models = {
    ...
    "SGDClassifier": SGDClassifier(max_iter=1000, n_jobs=-1),
    "HistGradientBoostingClassifier": HistGradientBoostingClassifier(),
}

# CSV file setup
csv_file = "ml_benchmark_results.csv"
...
for n_cores in range(max_cores, 0, -1):
    ...
    for model_name, model in models.items():
        ...
        with open(csv_file, mode="a", newline="") as file:
            writer = csv.writer(file)
            writer.writerow([model_name, n_cores, train_time, njob, prediction_time, accuracy, conf_matrix, f1])
